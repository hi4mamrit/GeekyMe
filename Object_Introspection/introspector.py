"""
Put sorted_set.py and introspector.py in a single location . Then create any ibject and use dump on it to get
variuos information on that object  in a well formatted-way

#create an integer object i=7 , a= list([1,2,3,4])
usage:-
...
def print_table(rows_of_columns, *headers):
    num_columns = len(rows_of_columns[0])	#value is 2
